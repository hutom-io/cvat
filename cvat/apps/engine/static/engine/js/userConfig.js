    ...
    constructor() {
        ...
        this._shortkeys = {
            ...
            switch_all_lock_property: {
                ...
                view_value: "T + L",
                description:
                    "switch lock property for all shapes on current frame"
            },
            ...
            aam_next_attribute: {
                ...
                description:
                    "move to next attribute in attribute annotation mode"
            },
            ...
            aam_prev_attribute: {
                ...
                view_value: "Up Arrow",
                description:
                    "move to previous attribute in attribute annotation mode"
            },
            ...
            aam_prev_shape: {
                ...
                description:
                    "move to previous shape in attribute annotation mode"
            },
            ...
            select_i_attribute: {
                ...
                description:
                    "setup corresponding attribute value in attribute annotation mode"
            },
        ...
        this._settings = {
            player_step: {
                value: "15",
                description:
                    "step size for player when move on several frames forward/backward"
            },
